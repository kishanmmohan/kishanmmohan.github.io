<template>
  <div class="min-h-screen bg-white dark:bg-[#191919]">
    <div class="max-w-3xl mx-auto px-8 py-20">
      <!-- Header -->
      <div class="mb-16">
        <h1
          class="text-5xl font-bold text-gray-900 dark:text-white mb-3 tracking-tight"
        >
          Kishan M Mohan
        </h1>
        <p class="text-xl text-gray-600 dark:text-gray-400 mb-8">
          Head of Engineering | Building high-performance engineering teams @
          <a
            href="https://nuark.ai"
            target="_blank"
            rel="noopener noreferrer"
            class="text-gray-900 dark:text-white hover:text-gray-700 dark:hover:text-gray-300 transition-colors"
            >nuark.ai</a
          >
        </p>
        ...
        <div class="flex gap-6 text-sm flex-wrap">
          <a
            href="mailto:madhanmohankishan@gmail.com"
          ...
          <a
            href="https://www.linkedin.com/in/kishanmmohan/"
            target="_blank"
            rel="noopener noreferrer"
            class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors flex items-center gap-2"
          >
          ...
          <a
            href="https://github.com/kishanmmohan"
            target="_blank"
            rel="noopener noreferrer"
            class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors flex items-center gap-2"
          >
      ...
      <div class="mb-12">
        <h2
          class="text-sm font-semibold text-gray-500 dark:text-gray-500 uppercase tracking-wider mb-4"
        >
          About
        </h2>
        <p
          class="text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4 text-justify"
        >
        ...
        <p
          class="text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify"
        >
      ...
      <div class="mb-12">
        <blockquote
          class="border-l-4 border-gray-300 dark:border-gray-700 pl-6 py-2"
        >
          <p
            class="text-lg italic text-gray-700 dark:text-gray-300 leading-relaxed"
          >
      ...
      <div class="mb-12">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          class="block p-4 border border-gray-200 dark:border-gray-800 rounded-lg hover:border-gray-300 dark:hover:border-gray-700 transition-colors"
        >
          <h3
      ...
      <div class="mb-12">
        ...
        <div class="flex flex-wrap gap-2">
          <span
            class="px-3 py-1 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm rounded"
          >
...
// No component imports needed - using pure HTML/CSS
  ...
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        "@type": "Person",
        name: "Kishan M Mohan",
        email: "madhanmohankishan@gmail.com",
