<template>
  <div class="min-h-screen bg-white dark:bg-[#191919]">
    <div class="max-w-3xl mx-auto px-8 py-20">
      ...
      <!-- Header: two-column on md+, stacked on mobile -->
      <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-8 mb-16">
        <!-- Left: name + subtitle -->
        <div>
          <h1 class="text-4xl font-semibold text-gray-900 dark:text-white mb-2 tracking-tight">
            Kishan M Mohan
          </h1>
        ...
        <div class="flex flex-row sm:flex-col gap-4 sm:gap-3 sm:items-end flex-wrap">
          <a
            href="mailto:madhanmohankishan@gmail.com"
            class="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors flex items-center gap-2"
          >
